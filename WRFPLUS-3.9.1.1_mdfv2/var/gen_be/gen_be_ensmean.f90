...
!
!---------------------------------------------------------------------- 
!  Purpose: Calculate ensemble average file from input WRF NETCDF input
!  ensemble members.
!
...
!  Open template ensemble average with write access:
...
!---------------------------------------------------------------------------------------------
   ...
   do v = 1, nv ! Loop over variables to average:
      var = cv(v)
      write(6,'(2a)')' Computing ensemble average for variable ', var
